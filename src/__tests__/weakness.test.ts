...
describe("calculateWeakness", () => {
  ...
  it("increases weakness for blank answers", () => {
    const telemetry: QuestionTelemetry = { id: "exam1::1", examId: "exam1", questionNumber: 1,
      timesCorrect: 0,
      timesWrong: 0,
      timesBlank: 2,
      consecutiveCorrect: 0,
...
describe("sortByWeakness", () => {
  it("sorts by weakness in descending order", () => {
    const items: QuestionTelemetry[] = [
      { id: "e1::1", examId: "e1", questionNumber: 1, timesCorrect: 0, timesWrong: 5, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 5, lastSeenAt: "" },
      { id: "e1::2", examId: "e1", questionNumber: 2, timesCorrect: 5, timesWrong: 0, timesBlank: 0, consecutiveCorrect: 5, avgResponseTimeMs: 0, totalSeen: 5, lastSeenAt: "" },
      { id: "e1::3", examId: "e1", questionNumber: 3, timesCorrect: 0, timesWrong: 2, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 2, lastSeenAt: "" },
    ];
...
describe("selectWeakestQuestions", () => {
  it("returns top N weakest questions", () => {
    const items: QuestionTelemetry[] = [
      { id: "e1::1", examId: "e1", questionNumber: 1, timesCorrect: 0, timesWrong: 5, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 5, lastSeenAt: "" },
      { id: "e1::2", examId: "e1", questionNumber: 2, timesCorrect: 5, timesWrong: 0, timesBlank: 0, consecutiveCorrect: 5, avgResponseTimeMs: 0, totalSeen: 5, lastSeenAt: "" },
      { id: "e1::3", examId: "e1", questionNumber: 3, timesCorrect: 0, timesWrong: 3, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 3, lastSeenAt: "" },
      { id: "e1::4", examId: "e1", questionNumber: 4, timesCorrect: 0, timesWrong: 1, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 1, lastSeenAt: "" },
    ];
  ...
  it("returns all items if count exceeds length", () => {
    const items: QuestionTelemetry[] = [
      { id: "e1::1", examId: "e1", questionNumber: 1, timesCorrect: 0, timesWrong: 5, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 5, lastSeenAt: "" },
      { id: "e1::2", examId: "e1", questionNumber: 2, timesCorrect: 0, timesWrong: 1, timesBlank: 0, consecutiveCorrect: 0, avgResponseTimeMs: 0, totalSeen: 1, lastSeenAt: "" },
    ];
...
describe("isQuestionMastered", () => {
  it("returns true for sufficiently practiced and consecutive correct", () => {
    const telemetry: QuestionTelemetry = { id: "e1::1", examId: "e1", questionNumber: 1,
      timesCorrect: 5,
      timesWrong: 0,
      timesBlank: 0,
      consecutiveCorrect: 3,
